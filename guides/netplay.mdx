---
title: "Netplay in RomM: WebRTC Multiplayer for Retro Games"
sidebarTitle: "Netplay"
description: "Set up peer-to-peer netplay rooms in RomM to play retro games online with friends. Configure ICE servers and manage active rooms via the API."
---
