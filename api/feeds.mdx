...
Add `http://<your-romm>:8080/api/feeds/tinfoil` as a custom shop URL in Tinfoil. See the [Tinfoil custom index docs](https://blawar.github.io/tinfoil/custom_index/) for setup.

---

## GET /api/feeds/pkgi/ps3/{content_type}
...
## GET /api/feeds/pkgi/psvita/{content_type}
...
## GET /api/feeds/pkgi/psp/{content_type}
...
## GET /api/feeds/fpkgi/{platform_slug}
...
## GET /api/feeds/kekatsu/{platform_slug}
