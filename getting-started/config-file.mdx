---
title: "RomM config.yml: Advanced Configuration File Reference"
sidebarTitle: "Config File"
description: "Use RomM's config.yml to configure scan exclusions, platform mappings, metadata priority, media assets, gamelist/Pegasus export, and EmulatorJS options."
---
